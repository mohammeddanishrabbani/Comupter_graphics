...
glTranslatef (x, y, z);
//move your item appropriately
glutSolidTeapot (0.1);
//render your teapot
glPopMatrix ();
//get back your state with the recent changes that you have done
}
...
void light()
{
// wall which is actually a CUBE
// set the lighting arrangements
...
light ();
//Adding light source to your project
...
glEnable(GL_LIGHT0);
// enable the lighting properties
